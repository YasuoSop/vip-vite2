<template>
  <div :class="['la-app', pageClass, { 'la-app-normal': showHeader }]">
    ...
    <div class="needUpgrade" :class="{ dn: !isIEAndLtIE11 }">
      <div class="container vm">
        <div class="content ma pr tc clearfix fs14">
          ...
          <a
            href="https://support.microsoft.com/zh-cn/help/17621"
            class="updateIE"
            >升级IE</a
          >
        </div>
    ...
    >
      ...
      <div class="content-box">
        ...
        >
          ...
          <div
            class="pointer btn-close pa"
            @click="guideClose"
            v-if="stepNum > 0 && stepNum < stepLists.length - 1"
          ></div>
    ...
    <div
      class="fix_box_udesk"
      :class="{ fix_box_udesk_one: $route.path === '/introduce' }"
      :style="{
        display:
    ...
    <div class="questionnaire" v-if="qDialog && guideRenewsFlags">
      <div class="q-box">
        ...
        <a
          class="q-box-btn"
          href="https://www.wenjuan.com/s/7fQn2aI/?user=popups&repeat=1"
          target="_blank"
        ></a>
      </div>
    </div>
    ...
    handleOutClick2() {
      ...
      window.open(
        `https://1537030.udesk.cn/im_client/?web_plugin_id=103301&agent_id=208981&group_id=300631&c_name=${
          isLogin ? encodeURI(_this.username) : "用户未登录"
        }&c_desc=${
          isLogin ? encodeURI(_this.grade_name) : "暂无描述"
