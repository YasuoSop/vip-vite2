...
<script>
import LeftInput from '@/components/inputs/trz/left-input.vue'
import LeftAutoInput from '@/components/inputs/trz/left-auto-input.vue'
import LeftDateRange from '@/components/inputs/trz/left-date-range.vue'
import LeftFullselect from '@/components/inputs/trz/left-fullselect.vue'
import LeftSelect from '@/components/inputs/trz/left-select.vue'
import LeftCheckBox from '@/components/inputs/trz/Left-check-box.vue'
