          ...
          <van-cell-group>
            ...
            <div class="selcet" style="margin-bottom: 20px">
              <div class="selcetlabel">
                <span style="color: #f00">*</span> 国际区号
              </div>
              <div style="flex: 1">
                <el-select
  ...
  methods: {
    ...
    checkEmail() {
      ...
      if (isEmailRight) {
        ...
        this.em.email = this.shenqingForm.email
          ? "请输入正确邮箱"
          : "请输入邮箱";
      }
    },
    ...
    async handleSubmit2(formName) {
      ...
      let allflag = Object.keys(this.em).every((v) => {
        return !this.em[v];
      });
