<template>
  <div class="header-trz" ref="header-trz">
    <div class="header-content">
      ...
      <div class="menu">
        <router-link tag="span" to="/trz/home" active-class="active" exact @click.native="handleClick('home')"
          >首页</router-link
        >
        <span>
          <div class="title">
          ...
          <div class="menu-items fadeInUp">
            <router-link
              ...
              class="menu-item"
              exact
              @click.native="handleClick('jigou')"
              >投资机构</router-link
            >
          </div></span
        >
        <span>
          ...
          <div class="menu-items fadeInUp">
            <router-link
              ...
              class="menu-item"
              exact
              @click.native="handleClick('rongzi')"
              >投融资事件</router-link
            >
            ...
            <router-link
              ...
              class="menu-item"
              exact
              @click.native="handleClick('binggou')"
              >并购事件</router-link
            >
            <img src="~@/assets/imgs/trz/menu-line.png" class="menu-line" />
            <router-link
              ...
              class="menu-item"
              exact
              @click.native="handleClick('kuajing')"
              >跨境交易项目</router-link
            >
          </div></span
        >
        <span>
          ...
          <div class="menu-items fadeInUp">
            <router-link
              ...
              class="menu-item"
              exact
              @click.native="handleClick('qiye')"
              >融资企业</router-link
            >
          </div></span
        >
        <router-link tag="span" to="/trz/news" active-class="active" exact  @click.native="handleClick('news')"
          >新闻动态</router-link
        >
        <span>
          <div class="title">
          ...
          <div class="menu-items fadeInUp">
            <router-link
              ...
              target="_blank"
              exact
              @click.native="handleClick('report')"
              >投融资分析报告</router-link
            >
            <img src="~@/assets/imgs/trz/menu-line.png" class="menu-line" />
            <router-link
              tag="a"
              to="/trz/map?map=rongzi"
              active-class="submenu-active"
              class="menu-item"
              target="_blank"
              exact
              @click.native="handleClick('rongzimap')"
              >投融资地图</router-link
            >
            <img src="~@/assets/imgs/trz/menu-line.png" class="menu-line" />
            <router-link
              tag="a"
              to="/trz/map?map=binggou"
              active-class="submenu-active"
              class="menu-item"
              target="_blank"
              exact
              @click.native="handleClick('binggoumap')"
              >并购地图</router-link
            >
            <!-- <img src="~@/assets/imgs/trz/menu-line.png" class="menu-line" />
            <router-link
