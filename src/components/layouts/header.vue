        ...
        <div class="header-right">
          ...
          <div v-if="$route.path !== '/home'" class="search-form-box">
            <form class="c-search-form" @submit.prevent="onSubmit">
              <el-select
                ...
                popper-class="header-elselect"
                :placeholder="$t('cSearch.common.select_placeholder')"
                ref="popoverSelect"
                @change="searchChange"
              >
                <el-option
                  v-for="(sc, index) in searchCategorys"
                  :label="$t('cSearch.searchCategorys.' + sc + '.label')"
                  :value="sc"
                  :key="index"
                ></el-option>
              </el-select>
              ...
              <inputPopover :value="searchwords">
                <el-input
                  ...
                  class="searchwords"
                  v-model="searchwords"
                  @keydown.enter.native.prevent="handleSearchClick"
                  @input="autoInput(searchwords)"
                  @focus="
              ...
              <a
                ...
                class="el-icon-search header-search-btn"
              ...
              <router-link
                ...
                native-type="submit"
                style="display: none"
                >{{ $t("cSearch.common.search") }}</router-link
              >
              <!-- 历史搜索提示下拉框 -->
              <div
                class="header-xiala-history"
                id="header-xiala-history"
              ...
              >
                ...
                >
                  ...
                  <i
                    class="el-icon-close"
                    @click.stop="deleteTheHistory(key)"
                  ></i>
                </a>
                <!-- 清空历史搜索 -->
              ...
              <!-- 输入提示下拉框 -->
              <div
                class="header-xiala-input"
                id="header-xiala-input"
          ...
          <div class="la-header-side">
            ...
            <el-popover
              ...
              v-model="popShow"
              visible-arrow="true"
              popper-class="msg-notice-popover"
              style
            >
              <!-- content -->
              <div>
                ...
                <div class="pop-content">
                  <div class="has-msg" v-if="allNum">
                    <div
                      ...
                      v-for="(item, index) in headerMsg.res"
                      :key="index"
                      @click="handleHeaderMsgRoute(item)"
                    >
                      <div
                        class="short-title"
                        :class="{
                ...
                <div class="pop-footer" v-if="allNum && allNum > 5">
                  <router-link to="/usercenter/message" class="more-msg"
                    >查看更多通知</router-link
                  >
                </div>
              </div>
            ...
            <el-dropdown class="la-header-dropdown">
              ...
              >
                ...
                <el-dropdown-item>
                  <router-link to="/home" @click.native="noviceEvent"
                    >新手教程</router-link
                  >
                </el-dropdown-item>
                <el-dropdown-item>
  ...
  .pop-content {
    ...
    .no-msg {
      ...
      .no-msg-detail {
        ...
        text-align: center;
        padding-top: 100px;
        background: url("/static/imgs/usercenter/header-more-msg.png") 0px 0px
          no-repeat;
      }
    }
  }
