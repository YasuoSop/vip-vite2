  ...
  <Main class="">
    ...
    <div slot="left">
      ...
      <div class="special-search">
        ...
        <a
          @click.prevent="handleCiGuanClick()"
          :class="{ 'abandon-click-method': nopms.getcg }"
          >词冠查询</a
        >
        <el-tooltip
          class="item"
          ...
          <div class="top-update-wrap">
            ...
            >
              <div slot="content">
                ...
                <a class="btn default" v-if="helpInfo.url" :href="helpInfo.url" target="_blank"
                  >帮助中心</a
                >
              </div>
    ...
    <!-- 词冠查询 - 弹框 -->
    <el-dialog
      :visible.sync="ciguanVisible"
      :modal-append-to-body="false"
      width="882px"
      class="report-special-search"
    >
      <div slot="title" class="dialog-header cgcx">
        词冠查询
      </div>
      <!-- 输入 -->
      <div class="special-inputs" v-if="!ciguanResult.length">
        <div class="special-input">
          ...
          <el-input
            placeholder="如：zumab"
            name="ciguanganwei"
            v-model="ciguanParam.ciguanganwei"
            clearable
          ></el-input>
        </div>
        <div class="special-input">
        ...
        <div class="special-input">
          <label>英文释义</label>
          <el-input
            placeholder="如：antiviral"
            name="ywshiyi"
            v-model="ciguanParam.ywshiyi"
            clearable
          ></el-input>
        </div>
        <div class="alert">
      ...
      <div slot="footer" class="dialog-footer">
        <div v-if="!ciguanResult.length">
          ...
          <el-button
            @click="clearCgParam"
            round
            class="dialog-query border-color"
            >清 空</el-button
          >
        </div>
        <div v-else>
          <el-button
            @click="specialNomalSearch"
            type="primary"
            round
            class="dialog-query"
            >搜 索</el-button
