    ...
    <div class="detail-item">
      ...
      <div v-show="chinaData.count">
        <div class="tabs mt12">
          ...
          <span class="tab-pane active">
            中国
            <span class="num">{{ chinaData.count }}</span>
          </span>
          <span
            class="export"
            v-if="!instruct"
      ...
      <div v-show="jpData.count">
        <div class="tabs mt12">
          ...
          <span class="tab-pane active">
            日本
            <span class="num">{{ jpData.count }}</span>
          </span>
          <span
            class="export"
            v-if="!instruct"
              ...
              <div v-if="item.prop === 'download'">
                ...
                <div class="download">
                  ...
                  <template v-else>
                    ...
                    <!-- 外部资源 -->
                    <template v-if="scope.row.tb == 3">
                      <a :href="scope.row.down" class="fujian" target="_blank">
                        <i class="iconfont download-icon">&#xe62c;</i>
                      </a>
                    </template>
                  </template>
      ...
      <div v-show="fdaData.count">
        <div class="tabs mt12">
          ...
          <span class="tab-pane active">
            美国
            <span class="num">{{ fdaData.count }}</span>
          </span>
          <span
            class="export"
            v-if="!instruct"
      ...
      <div v-show="unData.count">
        <div class="tabs mt12">
          <span class="tab-pane active">
            超说明书
            <span class="num">{{ unData.count }}</span>
          </span>
          <span
            class="export"
            v-if="!instruct"
