          ...
          <template :slot="item.tips ? 'header':''" slot-scope="scope">
            <span>
              ...
              <el-tooltip class="" effect="zhuce" placement="right">
                <div slot="content" v-if="item.prop == 'value'">{{helpDesc.salesVolume}}</div>
                <div slot="content" v-else-if="item.prop == 'oldvalue'">{{helpDesc.salesVolumeOld}}</div>
                <div slot="content" v-else-if="item.prop == 'oldunit'">{{helpDesc.monetaryUnit}}</div>
                <div slot="content" v-else-if="item.prop == 'shuoming'">{{helpDesc.pharmacologyType}}</div>
                <div slot="content" v-else-if="item.prop == 'company'">{{helpDesc.productCompany}}</div>
