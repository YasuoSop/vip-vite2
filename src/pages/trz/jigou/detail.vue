            ...
            <div class="charts">
              <div class="chart1">
                ...
                <div class="chart1-tips">
                  {{selectYear =='year'?'近一年':''}}投资数据(总计{{ allCount }})
                </div>
              </div>
              <div class="line"></div>
              <div class="chart2">
                ...
                <div class="chart1-tips">{{selectYear =='year'?'近一年':''}}投资地区分布(中国)</div>
              </div>
              <div class="chart3">
                <div id="chart3" class="chart1">
                  <NoData class="no-chart" v-if="tzlcLen === 0"></NoData>
                </div>
                <div class="chart1-tips">{{selectYear =='year'?'近一年':''}}投资轮次数量</div>
              </div>
              <div class="line"></div>
              <div class="chart4">
                ...
                <div class="chart1-tips">{{selectYear =='year'?'近一年':''}}独立投资规模(金额)数量</div>
              </div>
              <div class="chart5">
                <div id="chart5" class="chart1">
                  <NoData class="no-chart" v-if="tzhyLen === 0"></NoData>
                </div>
                <div class="chart1-tips">{{selectYear =='year'?'近一年':''}}投资行业占比</div>
              </div>
              <div class="line"></div>
              <div class="chart6">
                ...
                <div class="chart1-tips">{{selectYear =='year'?'近一年':''}}投资关键词TOP10</div>
              </div>
            </div>
          </div>
          <!-- 管理基金 -->
  ...
  methods: {
    ...
    linkToNews() {
      let routeData = this.$router.resolve({
        path: "/trz/news",
        query: {
          fourth_condition: `wyuid=${this.allWyuid}`
        }
      });
      window.open(routeData.href, "_blank");
    },
