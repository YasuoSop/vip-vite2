<template>
  <div class="trz-binggou">
    ...
    <LoadingGif :className="'fullscreen-loading'" :loadFlag="listLoading"></LoadingGif>
    <Main>
      <!-- 左边部分 -->
        ...
        <div class="page-content">
          ...
          <section class="part-section">
            <div class="sider-title">
              <img src="@/assets/imgs/tongji.png" style="width: 14px; height: 12px" alt />
              <span class="bold">
                分析图表
                <el-tooltip content="统计全部数据，不随左侧筛选变化。" placement="top" effect="light">
                  <img
                    src="~@/assets/imgs/trz/question.png"
                    height="14"
                    width="14"
            ...
            <div class="charts">
              <div class="chart1">
                <div id="chart1" class="chart1">
                  <NoData class="no-chart" v-if="bgslList.length === 0"></NoData>
                </div>
              ...
              <div class="chart2">
                <div id="chart2" class="chart2">
                  <NoData class="no-chart" v-if="amountList.length === 0"></NoData>
                </div>
                <div class="chart-tips">
                  近一年并购规模(金额)占比
                  <el-tooltip content="金额情况排除了“未披露”的数据" placement="top" effect="light">
                    <img
                      src="~@/assets/imgs/trz/question.png"
                      height="14"
                      width="14"
              ...
              <div class="chart3">
                <div id="chart3" class="chart3">
                  <NoData class="no-chart" v-if="provinceList.length === 0"></NoData>
                </div>
          ...
          <section class="part-section">
            <div class="sider-title">
              <img src="@/assets/imgs/list.png" style="width: 14px; height: 12px" alt />
              ...
              >
                ...
                <el-option label="金额最大靠前" value="guifan_amount desc"></el-option>
              </el-select>
            </div>
            ...
            <div
              ...
              v-if="res.length > 0"
            >
              <BinggouItem v-for="(item, index) in res" :key="index" :item="item" />
            </div>
            <NoData class="binggou-list" v-else :style="{ 'min-height': binggouMinHeight }"></NoData>
