  ...
  <div class="rongzi-detail">
    ...
    <div class="detail-container">
      <div style="display: flex; align-items: center; margin-bottom: 14px">
        <div
          class="title"
          v-if="infoObj.time || infoObj.acquirer || infoObj.shortname"
        >
          {{ formatterTitle() }}
          <!-- <span
            class="tag"
      ...
      <div class="rongzi-target" v-if="infoObj.amount">
        交易金额：
        <span style="color: #333;">{{ infoObj.amount }}</span>
      </div>
      <div class="cards">
        ...
        >
              ...
              <div class="left-info">
                ...
                <div class="summary-item" v-if="infoObj.acquirerArr && infoObj.acquirerArr.length>0">
                  ...
                  <a
                    ...
                    v-for="(item, index) in infoObj.acquirerArr"
                    style="color: #09144F;"
                    :key="index"
                ...
                >
                  <div>
                    <span>交</span><span>易</span><span>地</span
                    ><span>区：</span>
                  </div>
                  <div class="area">
          ...
          >
            ...
            <div class="company">
              ...
              <div
                class="company-info"
                v-for="(item, index) in gsxx.binggou"
                :key="'buy' + index"
              >
              ...
              <div
                class="company-info"
                v-for="(item, index) in gsxx.company"
                :key="'saler' + index"
              >
                <label v-if="item.companyname" class="key">名称：</label>
                <span v-if="item.companyname" class="value">{{
