            ...
            <div class="part-right">
              ...
              <div class="part-right-sider">
                ...
                <div class="sider-list">
                  ...
                  >
                    <span class="num">{{ index + 1 }}</span>
                    <span class="link" @click="toNewsList(item.label)">{{ item.label }}</span>
...
import THeader from "@/components/layouts/trz/header.vue"
import TContent from "@/components/layouts/main.vue"
