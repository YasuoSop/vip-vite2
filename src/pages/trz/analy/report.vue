  ...
  <div class="trz-report" :style="{ 'padding-top': loading ? '0' : '48px' }">
      ...
      <div class="header-content">
        ...
        <div class="report-header">
          <div class="left-container">
            ...
            <el-select
              v-if="date_type !== 1 && date_type !== 4"
              v-model="date_month"
              size="mini"
              @change="date_monthChange"
              class="select-sort"
            >
              <el-option
                v-for="(option, index) in dates"
                :key="index"
                :title="option.label"
                :label="option.label"
                :value="option.value"
    ...
    <div id="pdf-part1">
      <div class="trz-title-bg">
        <span class="title">{{
          reportTitleHandler(country, date_year, date_type, date_month)
        }}</span>
      </div>
      <!-- 行业数据概览 -->
        ...
        <div class="newtotals">
          <div class="newtotals-scroll">
            <ul class="total-item">
              ...
              <li class="li2">
                总计
                <span>{{ basic.event.current_total }}</span
                >件
              </li>
            ...
            <ul class="total-item">
              ...
              <li class="li2">
                总计
                <span>{{ basic.amount.current_total }}</span
                >{{ basic.amount.unit
                  ...
                  <img
                    ...
                    height="14"
                    width="14"
                    style="cursor: pointer;margin-left: 6px;position: relative;top: -2px;"
                /></el-tooltip>
              </li>
            ...
            <ul class="total-item">
              ...
              <li class="li2">
                总计
                <span>{{ basic.company.current_total }}</span
                >家
              </li>
            ...
            <ul class="total-item">
              ...
              <li class="li2">
                总计
                <span>{{ basic.jigou.current_total }}</span
                >家
              </li>
            ...
            <ul class="total-item">
              ...
              <li class="li2">
                总计
                <span>{{ basic.province.current_total }}</span
                >个
              </li>
            ...
            <ul class="total-item">
              ...
              <li class="li2">
                总计
                <span>{{ basic.industries.current_total }}</span
                >个
              </li>
            </ul>
            <ul class="total-item">
              ...
              <li class="li2">
                总计
                <span>{{ basic.keywords.current_total }}</span
                >个
              </li>
      ...
      <!-- 事件在行业与轮次的分布情况 -->
      <div
        v-if="sjInHYAndLCfbShow"
        class="sjInHYAndLCfb module"
        style="height: unset;flex-direction: column;"
      >
        ...
        <div class="container" style="flex-direction: column;">
          ...
          <div
            class="describe"
            style="width: 100%;justify-content: center;margin-top: 20px;margin-bottom: 30px;"
            v-html="sjInHYAndLCfbObj.describe"
          ></div>
        </div>
      </div>
      <!-- 事件规模占比情况 -->
      ...
      <div
        v-if="IPOKeywordShow"
        class="IPOKeyword module"
        style="height: unset;flex-direction: column;"
      >
        <span class="title">IPO热门关键词</span>
        <div class="container" style="justify-content: center;">
          <table
            class="IPOKeywordTable"
            border="1"
            cellspacing="0"
          ...
          <div
            style="display: flex;flex-direction: column;justify-content: center;align-items: start;margin-left: 115px;"
          >
            <div
              class="describe"
              style="width: 500px;"
              v-html="IPOKeywordObj.describe"
            ></div>
        ...
        <div class="footer-container">
          ...
          <div class="avatar-container">
            <div class="avatar-item">
              <img
                src="~@/assets/imgs/trz/tianjuan-avatar.png"
                class="avatar"
              />
              <div class="info">
              ...
              <img
                src="~@/assets/imgs/trz/tianjuan-qrcode.png"
                class="qrcode"
              />
            </div>
            <div class="line"></div>
            <div class="avatar-item">
              <img
                src="~@/assets/imgs/trz/xujianhua-avatar.png"
                class="avatar"
              />
              <div class="info">
                <div style="display:flex;align-items:end;margin-bottom: 14px;">
              ...
              <img
                src="~@/assets/imgs/trz/xujianhua-qrcode.png"
                class="qrcode"
              />
            </div>
          </div>
...
export default {
  ...
  methods: {
    reportTitleHandler(country, date_year, date_type, date_month) {
      let str = `${date_year}年${country}`;
      if (date_type === 4) {
        str = `${country}`;
      }
      if (date_month) {
        if (date_type === 2) {
          str += `${this.dates[date_month - 1].label}季度`;
        }
        if (date_type === 3) {
          str += `${date_month}月`;
        }
    ...
    async getYear() {
      ...
      let data = res.data.data.sort((a, b) => b - a);
      this.years = [];
      data.forEach(item => {
        this.years.push({
          label: item,
    ...
    date_typeChange(val) {
      this.date_type = val;
      if ([1, 4].includes(this.date_type)) this.taskSlice();
    },
    date_yearChange(val) {
      this.date_year = val;
      if (this.date_type === 1) this.taskSlice();
    },
    date_monthChange(val) {
      this.date_month = val;
      if ([2, 3].includes(this.date_type)) this.taskSlice();
    },
    // 行业数据概览
