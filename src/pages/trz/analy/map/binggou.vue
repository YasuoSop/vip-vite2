        ...
        <div @mouseleave="leaveMap()">
          ...
          >
            ...
            <div class="company" v-if="companyDetailArr.length > 0">
              <div class="company-title">最新并购事件</div>
              ...
              <div style="margin-bottom: 50px">
                ...
                >
                  ...
                  <span
                    ...
                    :title="item.amounts"
                    :data-name="item.country"
                    ><span v-if="item.amounts > 0">总计</span>
                    <span style="color: #e7af2f" v-if="item.amounts > 0">
                      {{ echartsTooltipMoney(item.amounts) }}
                    </span>
                    <span v-else>未披露</span>
                    <span v-if="item.amounts > 0">元</span></span
                  >
                </div>
              </div>
            </vueSeamlessScroll>
              ...
              <div style="margin-bottom: 50px">
                ...
                >
                  ...
                  >
                    ...
                    <span v-else>未披露</span
                    ><span v-if="item.amounts > 0">元</span>
                  </span>
                </div>
              </div>
            </vueSeamlessScroll>
          ...
          position(p, params) {
            if (params.data && params.data.name !== that.content) {
              ...
              if (p[1] + 720 <= height) {
                ...
                that.top = p[1] - (p[1] + 720 - height) + "px";
              }
            }
          },
        },
            ...
            position(p, params) {
              if (params.data && params.data.name !== that.content) {
                ...
                if (p[1] + 740 <= height) {
                  ...
                  // console.log(p[1] - (p[1] + 600 - height));
                  that.top = p[1] - (p[1] + 740 - height) + "px";
                }
              }
            },
          },
