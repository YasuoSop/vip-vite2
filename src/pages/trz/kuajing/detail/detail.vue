    ...
    <div class="detail-container">
      <div style="display: flex; align-items: center; margin-bottom: 14px">
        <div
          class="title"
        >
          交易项目：{{infoObj.guifan_item ? infoObj.guifan_item : infoObj.item}}
          <span
            v-if="infoObj.applicationscenarios && infoObj.applicationscenarios.length > 0"
          ...
          <span
            v-if="infoObj.therapeuticarea && infoObj.therapeuticarea.length > 0"
            class="tag1 tag-provice"
        ...
        >
          <div class="card" v-if="showSJGY === true">
            ...
            <div class="content">
              <div class="left-info">
                ...
                <div class="summary-item" v-if="infoObj.transferorArr && infoObj.transferorArr.length>0">
                  <div><span>转</span><span>让</span><span>方：</span></div>
                  <a
                ...
                <div class="summary-item" v-if="infoObj.buyerArr && infoObj.buyerArr.length>0">
                  <div><span>受</span><span>让</span><span>方：</span></div>
                  <a
                    class="touzifang-item"
                ...
                <div class="summary-item">
                  ...
                  <span style="color: #333;">总金额{{ infoObj.guifan_totalamount>0? echartsTooltipMoney(infoObj.guifan_totalamount) : '未披露' }} <span v-if="infoObj.guifan_totalamount>0">元</span> </span>，
                  <span style="color: #333;">首付款{{ infoObj.guifan_downpayment>0? echartsTooltipMoney(infoObj.guifan_downpayment) : '未披露' }} <span v-if="infoObj.guifan_downpayment>0">元</span></span>
                </div>
                <div
                  class="summary-item"
                  v-if="infoObj.area"
                >
                  <div style="width:165px;"><span>授权区域/合作企业总部：</span>
                  </div>
                  <div class="area">
                    {{infoObj.area}}
                  </div>
                ...
                <div class="summary-item" v-if="infoObj.guifanname || infoObj.brandname || infoObj.brandname_en">
                  <div><span>药</span><span>物：</span></div>
                  <span style="color: #333;">{{ infoObj.guifanname || infoObj.brandname || infoObj.brandname_en}}</span>
                </div>

                <div class="summary-item" v-if="infoObj.targets_abbr || infoObj.targets">
                  <div><span>靶</span><span>点：</span></div>
                  <span style="color: #333;">{{ infoObj.targets_abbr || infoObj.targets }}</span>
                </div>
              </div>
            </div>
            <div class="content2">
              ...
              <div class="info-item" v-if="infoObj.therapeuticarea &&
                    infoObj.therapeuticarea.length > 0">
              ...
              <div class="info-item" v-if="infoObj.guifan_cooperationtype || infoObj.cooperationtype">
                <div class="info-label">合作类型</div>
                <div class="info-desc">
                  {{ infoObj.guifan_cooperationtype || infoObj.cooperationtype}}
                </div>
              </div>
              ...
              <div class="info-item" v-if="infoObj.guifan_developmentstatus || infoObj.developmentstatus">
          ...
          >
            ...
            <div class="company">
              ...
              <h4 class="company-title" v-if="gsxx.buyer.length > 0">
                受让方
              </h4>
              <div
                class="company-info"
        ...
        <div class="right-content">
          <div class="card">
            <div class="card-title">
              ...
              <div
                class="refresh-btn"
                @click="goToNewsList(`${infoObj.transferoruid}ღ${infoObj.buyeruid}`)"
                v-if="newsCount > 6"
              >
                查看更多
              </div>
