    ...
    <div class="rongzi-item_left">
      ...
      <div class="left-info">
        <div class="left-info-title">
          <span style="color: #3556b9; font-size: 16px;font-weight: bold;" v-if="item.guifanname || item.brandname || item.brandname_en">【{{item.guifanname || item.brandname || item.brandname_en}}】</span>
          <span style="color: #3556b9; font-size: 16px;font-weight: bold;" v-if="item.targets_abbr || item.targets">【{{item.targets_abbr || item.targets}}】</span>
          <router-link
        ...
        <div class="left-box">
          ...
          <div class="left-amount">
            交易金额：<span
              >总金额{{
                item.guifan_totalamount>0
                  ? echartsTooltipMoney(item.guifan_totalamount)
                  : "未披露"
              }}
              <span v-if="item.guifan_totalamount>0">元</span></span
            >，<span
              >首付款{{
                item.guifan_downpayment>0
                  ? echartsTooltipMoney(item.guifan_downpayment)
                  : "未披露"
              }}
              <span v-if="item.guifan_downpayment>0">元</span></span
            >
          </div>
        </div>
      </div>
