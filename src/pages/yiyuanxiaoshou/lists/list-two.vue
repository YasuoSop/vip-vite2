              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <div  :title="scope.row[item.prop]" v-if="item.prop === 'dw'">
                      万元
                    </div>
  ...
  export default{
    ...
    computed: {
      ...
      ...mapState({
        ...
        res2: state => _.keys(state.Yyxs.res2).length ? state.Yyxs.res2.res : [],
    ...
    methods: {
      ...
      handleRequest (props) {
        Store.dispatch("Yyxs/getGroupRes",{path:'/api/yyxs/byname',params:this.expandParams}).then(res=>{
      ...
      sortChange (column, prop, order) {
        ...
        Store.commit('Yyxs/order', Object.assign({}, this.$store.state.Yyxs.order, {name: sort ? sort : null}))
        Store.dispatch('Yyxs/nomalSearch',{params:this.param})
      },
      // 获取展开列表的数据
      ...
      toggleRowExpansion(row, column, cell, event){
        ...
        window.ga("send","event", "txt", "click","yyxs_"+"_byname_"+column.property);
        window._paq.push(['trackEvent', 'txt',"click","yyxs_"+"_byname_"+column.property, ])
