<template>
  <Main class="yiyuanxiaoshou" >
    ...
    <div slot="left">
      ...
      <!-- 条件筛选（普通/高级搜索之后的二次筛选） -->
      <Filters vuex_name="Yyxs" route1="list" route2="analy"></Filters>
      <!-- 保存的条件 -->
    ...
    <div class="la-right">
      ...
      <section class="sec1 clearfix" :class="{'sec1-onTrial':onTrial}">
        ...
        <div v-if="onTrial" class="database-name-accessory">（您当前为试用用户，仅提供2016，2017，2018年销售数据可查，正式用户可查最新数据）</div>
      </section>
      <section class="sec2">
        ...
        <div class="search-body-content">
          <Optioned
            @showSavedPop="()=>savedPopVisible = true"
            @clearLeft="clearLeft"
            ...
            route1="list"
            route2="analy">
            <div class="analy fr" v-if="route==='analy'">
              <i-wave />
              <span>
