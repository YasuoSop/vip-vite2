    ...
    methods: {
          ...
          switch (currNav) {
            case '药品分析':
              callMethods = [
                ...
                this.analyYpfxfeiyong(searchName, this.ghAnaly.company.slice(0, 10).join(','), null, guige, bzguige),
      ...
      ananlyPriceSearch (currNav, index, arrVal, val2) {
        ...
        this.analyYpfxfeiyong(
          this.ghAnaly.tmpObj.right[1].leftText, arrVal.join && arrVal.join(',') || arrVal, val2, this.ghAnaly.tmpObj.right[3].default,
          (this.ghAnaly.tmpObj.right[3].default2 == '全部'?null:this.ghAnaly.tmpObj.right[3].default2.split('*')[1])
        ).then(res => {
