 	...
 	<div class="gh-analy dialog">
		...
		<div class="cont">
			<div class="left">
				...
				<div v-for="(curr, index) in A.nav" v-if="A.nav.length" class="A" :class="[A.activeValue == curr.value ? 'active':'']" @click="$emit(A.clickNav, index, curr.value)" :key="curr.value">
					{{ curr.label }}
				</div>
			</div>
			...
			<!-- <el-scrollbar> -->
                ...
                :popper-append-to-body="false"
							...
							<div v-if="curr.name == 'D'" class="D fs13 clearfix tc">
								...
								<li v-for="i in curr.data">
									...
									<div class="gg-company">
										{{ i.guige }}<span class="company" v-if="i.company">&nbsp;&nbsp;{{ i.company }}</span>
									</div>
									<div>
							...
							<div v-if="curr.name == 'E'" class="E fs13">
								<table>
									...
									<tr>
										...
										<td>
											<el-radio-group v-model="curr.default" @change="val => {curr.change(A.activeValue, index, val, curr.default2)}">
											<el-radio-button v-for="i in curr.group" :key="i" :label="i"></el-radio-button>
										</el-radio-group>
										</td>
									</tr>
									<tr>
										...
										<td>
											<el-radio-group v-model="curr.default2" @change="val => {curr.change2(A.activeValue, index, curr.default, val)}">
											<el-radio-button v-for="i in curr.group2" :key="i" :label="i"></el-radio-button>
										</el-radio-group>
										</td>
									</tr>
								</table>
					...
					<!-- 时间维度分析 -->
							...
							<el-select
								v-model="curr.default2"
								popper-class="gh-analy" class="el-select-2 ml10"
								@change="$emit(curr.clickBtn, A.activeValue, index, curr.default, curr.default2)">
								<el-option
									v-for="item in curr.option2"
									:key="item.value"
									:label="item.label"
									:value="item.value">
								</el-option>
							...
							<div v-if="curr.name == 'G'" class="G">
								...
								<div class="wdSearch ml18">
									...
									<template v-if="curr.isMultiple">
										<el-select
											v-model="curr.default" :placeholder="curr.placeholder" multiple filterable
											:multiple-limit="10"
								...
								<el-select
									v-model="curr.default2" :placeholder="curr.placeholder2"
									popper-class="gh-analy" class="el-select-2 ml10"
									@change="$emit(curr.clickBtn, A.activeValue, index, curr.default, curr.default2)">
									<el-option
										v-for="item in curr.option2"
							...
							<div v-if="curr.name == 'K'" class="K">
								...
								<div class="wdSearch ml18">
									<el-select
										v-model="curr.default"
										popper-class="gh-analy" class="el-select-2"
							...
							<div v-if="curr.name == 'L'" class="L">
								...
								<div class="wdSearch ml18">
									<el-select
										v-model="curr.default" placeholder="请选择" multiple filterable
										collapse-tags popper-class="gh-analy" class="el-select-1"
										@change="$emit(curr.clickBtn, A.activeValue, index, curr.default, curr.default2)">
								<el-option
									v-for="item in curr.option"
							...
							<el-select
								v-model="curr.default2" placeholder="请选择"
								popper-class="gh-analy" class="el-select-2 ml10"
								@change="$emit(curr.clickBtn, A.activeValue, index, curr.default, curr.default2)">
								<el-option
									v-for="item in curr.option2"
...
<style lang="less">
    ...
    min-width: 1200px;
		...
		input.el-input__inner::-moz-placeholder{   /* Mozilla Firefox 19+ */
			color:#52586A;
		}
		input.el-input__inner:-moz-placeholder{    /* Mozilla Firefox 4 to 18 */
			color:#52586A;
		}
		input.el-input__inner:-ms-input-placeholder{  /* Internet Explorer 10-11 */
			color:#52586A;
		}
