            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <div v-if="item.prop === 'caozuo'">
                  <el-button type="primary" round size="mini" @click="hanldeSavedSearch(scope.row.dbename, scope.row.whereinfo)">检索</el-button>
                  <el-button type="danger" round size="mini" @click="handleDelOption(scope.row.id, scope.row.dbename)">删除</el-button>
                </div>
              </template>
            </el-table-column>
          </el-table>
