      ...
      <div class="section">
        ...
        <div class="all-none" v-if="!data.count">
          ...
          <div class="all-none-msg">
            <span>您还没有订阅任何数据噢，马上去 <router-link tag="a" to="/usercenter/take/new" class="link-blue">添加</router-link></span>
          </div>
        </div>
        <!-- PART:订阅动态(有) -->
            ...
            v-for="item in tableHead"
              ...
              <template slot-scope="scope">
                ...
                <div v-if="item.prop === 'caozuo'">
                  <el-button type="info" round size="mini" @click="deleteRow(scope.row.id)" style="background: #97A2BF;color: #fff;padding: 4px 13px;line-height: 1;">取消</el-button>
                </div>
              </template>
            </el-table-column>
          </el-table>
