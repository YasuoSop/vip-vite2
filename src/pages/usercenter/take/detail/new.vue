            ...
            <el-form ref="newTakeForm" :model="newTakeForm" label-width="120px">
              <el-form-item label="订阅数据库：">
                ...
                >
                  ...
                  <el-option label="投融资事件" value="投融资事件"></el-option>
                  <el-option label="并购事件" value="并购事件"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="分类：" v-if="shujuku == 2 || shujuku == '药品注册与受理数据库'">
             ...
             <el-form-item label="分类：" v-if="shujuku == '投融资事件' || shujuku == '并购事件'">
                <el-radio-group v-model="category" @change="categoryChange">
                  <el-radio :label="'全部'">全部</el-radio>
                  <el-radio :label="'关键词'">关键词</el-radio>
                  <el-radio :label="'行业'">行业</el-radio>
                  <el-radio :label="'轮次'" v-if="shujuku == '投融资事件'">轮次</el-radio>
                  <el-radio :label="'地区'">地区</el-radio>
                </el-radio-group>
              </el-form-item>

              <el-form-item label="关键词：" v-if="shujuku == 2 || shujuku == '药品注册与受理数据库'">
                <el-autocomplete
                  v-model="slhkeyword"
  ...
  methods: {
            ...
            window
              .Axios({
                ...
                params: _.assign(
                  ...
                  (this.shujuku !='投融资事件' && this.shujuku !='并购事件') ? otherParams : {}
                ),
              })
              .then((res) => {
    ...
    categoryChange(val) {
      ...
      if (val !== '全部') {
        ...
        window._paq.push(['trackEvent', 'button', 'click', "viptrz_dingyue_more" ])
