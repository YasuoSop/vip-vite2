      ...
      <div class="section">
        ...
        <div class="sec-view" v-if="data.history && data.history.length > 0">
          <div class="head">
            <router-link
              tag="a"
              :to="{ path: '/zhuce/' + data.id }"
              target="_blank"
              ><span>{{ data.shoulihao }}</span></router-link
            >
            <span>{{ data.name }}</span>
          ...
          <router-link
            ...
            target="_blank"
          >
            <div class="more-btn">查看详情</div></router-link
          >
        </div>
      ...
      .sec-view {
        ...
        .main {
          ...
          .main-head {
            ...
            .left {
              background: url("/static/imgs/usercenter/qian.jpg") 96px 6px
                no-repeat;
              padding-left: 130px;
            }
            .middle {
            ...
            .right {
              background: url("/static/imgs/usercenter/hou.jpg") 96px 5px
                no-repeat;
              padding-left: 130px;
            }
          }
