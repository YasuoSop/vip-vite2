        ...
        <div class="right-wrap">
          ...
          <div class="right-word">
            ...
            <span v-show="edition" class="one_banben">
              ...
              <a
                class="banben_run"
                href="/updatelog?ga_source=vip&ga_name=login"
                target="_black"
              >
                  ...
                  <div class="password-wrap">
                    <form @submit.prevent="accountSubmit">
                      ...
                      >
                        ...
                        ></el-input>
                        <i
                          class="iconfont pwd-handler"
                          v-show="iptType == 'password'"
                          @click="disPwd('password')"
                          >&#xe668;</i
                        >
                        <i
                          class="iconfont pwd-handler"
                      ...
                      <div class="forgetpassword memory-pwd clearfix">
                        ...
                        >
                        <a
                          href="https://www.yaozh.com/login/forget/"
                          class="fr"
                          target="_blank"
                          >忘记密码?</a
                        >
                      ...
                      <el-button
                        ...
                        native-type="submit"
                        class="loginButton"
                        :disabled="acc.btnEnable"
                        >{{ acc.btnText || this.t.a }}</el-button
                      >
                      <div class="forgetpassword handler-btn">
                        <a
                          href="https://www.yaozh.com/register?ga_source=vip&ga_position=registered_1"
                          target="_blank"
                          >立即注册</a
                        >
                        <a
                    ...
                    <form @submit.prevent="smsSubmit">
                      ...
                      <div class="messages">
                        ...
                        <el-button
                          ...
                          :disabled="sms.codeBtnBan"
                          @click="sendCode"
                          >{{ sms.codeBtnText || this.t.b }}</el-button
                        >
                      </div>
                      ...
                      <el-button
                        ...
                        native-type="submit"
                        class="loginButton"
                        :disabled="sms.btnEnable"
                        >{{ sms.btnText || this.t.a }}</el-button
                      >
                      <div class="forgetpassword handler-btn">
                        <a
                          href="https://www.yaozh.com/register?ga_source=vip&ga_position=registered_1"
