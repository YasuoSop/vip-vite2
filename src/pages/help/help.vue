        ...
        <div class="help_content">
          ...
          <div class="help_search">
            ...
            <div class="content_search">
              <el-input @keydown.enter.native.prevent="nameSearch('2')" class="ser_question" placeholder="请输入您想要查找的关键词，例如数据库名称" v-model="searchVal" value=""></el-input>
            </div>
            ...
            <div class="select">
              <el-collapse v-model="activeNames" accordion>
                <el-collapse-item v-for="(item, index) in lists" :key="index" :name="item.name + '^' +item.id">
                  ...
                  <div class="item1" v-for="(item1, index) in item.children" :key="index" @click="handleChange2(item1)" v-if="item1.id != '3a4'">
                    {{item1.name}}
                  </div>
                  <div class="item1" v-else>
                    <span onclick="window.open('https://zy.yaozh.com/product_manual.pdf')">{{item1.name}}</span>
                  </div>
                </el-collapse-item>
              </el-collapse>
            </div>
