        ...
        <div class="chart_top">
          <div class="newtotals">
            ...
            <ul class="total-item">
              ...
              <li class="li2">
                总计
                <span class="num-s">{{ basicDataObj.zxguifanname_count }}</span
                >个
              </li>
            </ul>
            <ul class="total-item">
            ...
            <ul class="total-item">
              ...
              <li class="li3">
                ...
                <span v-if="basicDataObj.guifanguige_the_highest_decline"
                  >（{{ basicDataObj.guifanguige_the_highest_decline }}）</span
                >
              </li>
              <li class="li3">
            ...
            <ul class="total-item">
              ...
              <li class="li3">
                ...
                <span v-if="basicDataObj.guifanguige_the_minimum_decline"
                  >（{{ basicDataObj.guifanguige_the_minimum_decline }}）</span
                >
              </li>
              <li class="li3">
            ...
            <ul class="total-item">
              ...
              <li class="li3" style="padding-top: 0">
                ...
                <span
                  ...
                  "
                  @click="lookMore"
                  >{{ basicDataObj.yzxpj_jindu_weijinru }}</span
                >
                个
              </li>
            </ul>
        ...
        <div class="echarts-wrap">
          ...
          <div class="echart-item" ref="echartItem">
            ...
            <div class="echarts-container">
              <div v-show="isShowQS">
                <div
                  v-show="shouNianYueDingQSObj.xiaoshoue.length > 0"
                  class="echarts"
                  ref="shouNianYueDingQS"
                  id="shouNianYueDingQS"
                ></div>
                <div
                  class="shadow"
                  v-show="shouNianYueDingQSObj.xiaoshoue.length == 0"
              ...
              <div
                v-show="shouNianYueDingZZObj.xiaoshoue.length > 0"
                class="echarts"
                ref="shouNianYueDingZZ"
                id="shouNianYueDingZZ"
              ></div>
              <div
                class="shadow"
                v-show="shouNianYueDingZZObj.xiaoshoue.length == 0"
