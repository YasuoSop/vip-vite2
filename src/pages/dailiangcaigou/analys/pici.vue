<template>
  ...
  <div class="pici-analy">
    ...
    <template>
      ...
      <!-- 批次信息基本数据模块 -->
      <div class="info" v-if="Object.keys(piciData).length > 0">
        <!-- 批次筛选模块 -->
        ...
        <div class="pici-info">
          ...
          <ul class="total-item">
            ...
            <li class="li2">{{piciData.most_selected_companies}}最多<br>共<span>{{piciData.most_selected_companies_nums}}</span>个品种</li>
          </ul>
          <ul class="total-item">
            <li class="li1">平均降幅</li>
            <li class="li2"><span class="f24">{{piciData.average_drop}}</span></li>
            <!-- 环比为空的时候不显示 -->
            <li class="li2" v-if="piciData.average_drop_month_on_month">环比（{{piciData.average_drop_pici}}）<br>{{averageText}}<span>{{piciData.average_drop_month_on_month}}</span></li>
          </ul>
          <ul class="total-item">
            <li class="li1">最高降幅品种
            ...
            <!-- 降幅为空的时候不显示 -->
            <li class="li2" v-if="piciData.highest_rate_of_decrease">{{piciData.the_name_of_the_highest_drop_drug}}</li>
            <li class="li2" v-if="piciData.highest_rate_of_decrease">{{piciData.name_of_the_company_with_the_highest_decline}}<br>中选价：<span>{{piciData.the_highest_price_drop}}</span>元<br>降幅：<span>{{piciData.highest_rate_of_decrease}}</span></li>
          </ul>
          <ul class="total-item">
            <li class="li1">最低降幅品种</li>
            <li class="li2">{{piciData.name_of_the_lowest_drop_drug}}</li>
            <li class="li2">{{piciData.minimum_decrease_company_name}}<br>中选价：<span>{{piciData.the_lowest_price_drop}}</span>元<br>降幅：<span>{{piciData.minimum_rate_of_decrease}}</span></li>
          </ul>
        </div>
      </div>
      ...
      <div class="chart-wrap">
        ...
        <i-echart v-if="Object.keys(zdzxOption).length > 0" :option="zdzxOption" class="echarts-container1" :width="width" :height="900"></i-echart>
      ...
      <div class="chart-wrap">
        ...
        <i-echart v-if="Object.keys(ypjfOption).length > 0" :option="ypjfOption" class="echarts-container1" :width="width" :height="900"></i-echart>
        <div class="shadow" v-else>
          <img src="../../../../static/imgs/nodata.png" alt="">
        </div>
      </div>
      ...
      <div class="chart-wrap">
        ...
        <i-echart v-if="Object.keys(pzzgjfOption).length > 0" :option="pzzgjfOption" class="echarts-container2" :width="width" :height="600"></i-echart>
        <div class="shadow" v-else>
          <img src="../../../../static/imgs/nodata.png" alt="">
        </div>
      </div>
      ...
      <div class="chart-wrap">
        ...
        <i-echart v-if="Object.keys(qyzxOption).length > 0" :option="qyzxOption" class="echarts-container2" :width="width" :height="600"></i-echart>
        <div class="shadow" v-else>
          <img src="../../../../static/imgs/nodata.png" alt="">
        </div>
      </div>
      ...
      <div class="chart-wrap">
        ...
        <i-echart v-if="Object.keys(qyssOption).length > 0" :option="qyssOption" class="echarts-container2" :width="width" :height="600"></i-echart>
        <div class="shadow" v-else>
          <img src="../../../../static/imgs/nodata.png" alt="">
        </div>
      </div>
      ...
      <div class="chart-wrap">
        ...
        <div class="chart-box" v-if="Object.keys(jxfbBarOption).length > 0">
          <!-- 堆叠图 -->
          <i-echart v-if="Object.keys(jxfbBarOption).length > 0" :option="jxfbBarOption" class="echarts-container3" :width="(width-20)/2" :height="700"></i-echart>
          <!-- 饼图 -->
          <i-echart v-if="Object.keys(jxfbPieOption).length > 0" :option="jxfbPieOption" class="echarts-container3" :width="(width-20)/2" :height="700"></i-echart>
        </div>
        <div class="shadow" v-else>
          <img src="../../../../static/imgs/nodata.png" alt="">
        </div>
      ...
      <div class="chart-wrap">
        ...
        <div class="chart-box" v-if="Object.keys(atcBarOption).length > 0">
          <!-- 堆叠图 -->
          <i-echart v-if="Object.keys(atcBarOption).length > 0" :option="atcBarOption" class="echarts-container3" :width="(width-20)/2" :height="700"></i-echart>
          <!-- 饼图 -->
          <i-echart v-if="Object.keys(atcPieOption).length > 0" :option="atcPieOption" class="echarts-container3" :width="(width-20)/2" :height="700"></i-echart>
        </div>
        <div class="shadow" v-else>
          <img src="../../../../static/imgs/nodata.png" alt="">
        </div>
    ...
    <el-dialog :visible.sync="dialogTableVisible" :modal-append-to-body="false" width="800px">
      ...
      <el-table
        :data="lbData.slice((currentPage - 1) * pageSize, currentPage * pageSize)"
        stripe
        fixed>
...
<style lang="less" scoped>
  ...
  .pici-analy {
    ...
    .db-index-loading {
      ...
      position: fixed;
      top: 48px;
      width: calc(100vw - @LeftSideWidth - 51px);
