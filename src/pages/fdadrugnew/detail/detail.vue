            ...
            >
              <div class="tb-wrap">
                ...
                <div
                  ...
                  :key="ix"
                  class="equiv-lz"
                  :class="{ selected: curAnchor === items.strength }"
                >
                  <p>
                    <span>规格</span>（
                    <span class="fontw">{{ items.strength }}</span
                    >）
                  </p>
                  <el-table
                    :data="items.child"
                  ...
                  >
                    ...
                    <template slot-scope="scope">
                      ...
                      <div
                        ...
                        style="display: -webkit-box;-webkit-box-orient: horizontal;"
                      >
...
export default {
  ...
  methods: {
    ...
    TableHeaderStyle(val) {
      return {
        background:
          this.curAnchor === val ? "rgba(255, 245, 242) !important" : ""
      };
    },
    // 锚链接跳转
    anchor(anchorName) {
