  ...
  <div class="wrapper" ref="wrapper">
    ...
    <div class="detail-list" v-else>
      ...
      <div class="main">
          ...
          <div class="tb-wrap">
            <table class="tb-t">
              ...
              <tr v-if="base_info.appltype">
                <td>
                  ...
                  <el-tooltip effect="light" placement="right">
                    <div slot="content">生物药CBER即“生物制品审评与研究中心“批准的产品，包括过敏原性、血液制品、细胞和基因治疗、疫苗等产品。</div>
              ...
              <tr v-if="base_info.submissionstatusdate1">
                <td>上市日期</td>
                <td colspan="3" >
                  <div class="td-line5">{{ base_info.submissionstatusdate1 }}</div>
                </td>
              </tr>
              ...
              <tr v-if="base_info.productInformation">
                ...
                <td colspan="3" >
                  <div class="td-line5">
                    <a :href="base_info.productInformation" target="_blank" class="link-a">查看</a>
                  </div>
                </td>
              </tr>
              <tr v-if="base_info.supportingdocuments">
                ...
                <td colspan="3" >
                  <div class="td-line5">
                    <a :href="base_info.supportingdocuments" target="_blank" class="link-a">查看</a>
                  </div>
                </td>
              </tr>
            </table>
        ...
        <a href="#" name="part8" ></a>
        <slide-section :title="'扩展信息'" class="the-part" v-if="extendList&&extendList.length">
  ...
  export default{
    ...
    methods:{
      ...
      handleScroll () {
        ...
        if(scrollTop < -h1+40) {
          $('.left-nav-in').css({"top": h + 20 + 15 + 48, "left": 10, "position": "fixed"})
        } else {
