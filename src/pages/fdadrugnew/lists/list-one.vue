        ...
        <el-table-column
          ...
          :label="item.label">
            ...
            <template slot-scope="scope">
              <div v-if="vueCheckListPms('Fdadrugnew', item.label)" :title="scope.row[item.prop]">
                ...
                <div v-else-if="item.prop === 'drugname'" :title="scope.row.drugname">
  ...
  export default{
    ...
    computed: {
      ...
      ...mapState({
        ...
        res1: state => _.keys(state.Fdadrugnew.res1).length ? state.Fdadrugnew.res1.res : [],
