  ...
  methods: {
    ...
    handleAxios() {
      ...
      Axios.get("/api/search?" + params)
        ...
        .then(() => this.commonAxios("doc", "药品研发")) // 单独添加全球药品审评报告
        .then(() => this.commonAxios("yyxs", "市场信息")) // 单独添加医院销售数据
        .then(() => this.commonAxios("dailiangcaigou", "市场信息")) // 单独添加带量采购数据库
        .then(() => this.commonAxios("dae", "合理用药")) // 单独添加药品应用评价数据
