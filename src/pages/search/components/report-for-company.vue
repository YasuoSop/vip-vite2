<template>
  <div class="report" :class="{'fillHeight':!Object.keys(data).length}" :style="{ minHeight: `calc(100vh - 40px - 48px - ${ (showPromtNotice ? 30 : 0) + 'px'}` }">
      ...
      <div class="main-desc">
        <div class="desc-title">
          <div class="lan1 clearfix">
            <span class="zh-name fl">{{data.qymc}}</span>
            <span class="item item1" style="margin-left:0;" v-if="data.qyguojia">{{data.qyguojia}}</span>
            <span class="item item2" v-if="data.jyzt">{{data.jyzt}}</span>
            <span class="item item3" v-if="data.rzlc">{{data.rzlc}}</span>
          </div>
          <div class="lan2" v-if="data.ywmc">
            <span class="en-name">{{data.ywmc}}</span>
          </div>
        </div>
      ...
      <div class="main-num">
          ...
          <div class="num-item item1">
            ...
            <div class="num-detail">
              <span class="num-big" id="countup1"></span><span class="super">个(总)</span>
              <span class="hr">|</span>
          ...
          <div class="num-item item3">
            ...
            <div class="num-detail">
              <span class="num-big" id="countup3"></span><span class="super">个(总)</span>
              <span class="hr">|</span>
          ...
          <div class="num-item item2">
            ...
            <div class="num-detail">
              <span class="num-big" id="countup5"></span><span class="super">个(中国)</span>
              <span class="hr">|</span>
          ...
          <div class="num-item item4">
            ...
            <div class="num-detail">
              ...
              <span class="hr">|</span>
              <span class="num-big" id="countup8"></span><span class="super">个(近一年)</span>
            </div>
          </div>
      </div>
    </div>
    ...
    <div class="rp-desc" v-if="Object.keys(data).length">
      <div class="rp-desc-main" v-if="data.qyjj">
        <div class="desc-head">
          <div class="desc-title">
        ...
        <div class="desc-content">
          <div class="content" v-html="data.qyjj"></div>
          <table class="desc-detail">
            <!-- 企业网址 -->
            <tr>
              <td>企业网址</td>
              <td v-if="data.qygw"><a :href="'http://' + data.qygw" target="_blank">{{data.qygw}}</a></td>
              <td v-else>无</td>
            </tr>
            <!-- 成立日期 -->
            <tr>
              <td>成立日期</td>
              <td v-if="data.clrq">{{data.clrq}}</td>
              <td v-else>无</td>
            </tr>
            <!-- 法定代表 -->
            <tr>
              <td>法定代表</td>
              <td v-if="data.fddb">{{data.fddb}}</td>
              <td v-else>无</td>
            </tr>
            <!-- 注册资本 -->
            <tr>
              <td>注册资本</td>
              <td v-if="data.zczb">{{data.zczb}}</td>
              <td v-else>无</td>
            </tr>
            <!-- 企业标签 -->
            <tr>
              <td>企业标签</td>
              <td v-if="data.qybq">{{data.qybq}}</td>
              <td v-else>无</td>
            </tr>
            <!-- 企业标志 -->
              <tr>
      ...
      <router-link tag="a" :to="{path: '/company/' + data.id}" target="_blank" class="desc-more">查看企业详情</router-link>
    </div>
  </div>
</template>
      ...
      handler(){
        ...
        this.$nextTick(()=>{
          ...
          let pr = new Promise((resolve, reject) => {
            ...
            let cu3 = new CountUp('countup3', 0, this.data.count_arr.count_linchuang ? this.data.count_arr.count_linchuang : 0, 0, 1, options);
            ...
            let cu5 = new CountUp('countup5', 0, this.data.count_arr.count_ssyp_gn ? this.data.count_arr.count_ssyp_gn : 0, 0, 1, options);
            let cu6 = new CountUp('countup6', 0, this.data.count_arr.count_ssyp_gw ? this.data.count_arr.count_ssyp_gw : 0, 0, 1, options);
            let cu7 = new CountUp('countup7', 0, this.data.count_arr.count_yaopinzhongbiao ? this.data.count_arr.count_yaopinzhongbiao : 0, 0, 1, options);
