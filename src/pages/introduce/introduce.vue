<template>
  <div>
    ...
    <div class="introduce" v-else>
      ...
      <!-- 试用申请弹出框 -->
      <el-dialog
        :visible.sync="dialogProbationShow"
      ...
      <div class="introduce_wrapper">
        ...
        <div class="introduce_nav">
          <div class="introduce_header">
            ...
            >
              <ul>
                ...
                <li>
                  <a
                    href="javascript:;"
                    @click="() => (navHelpShow = !navHelpShow)"
                    >帮助中心<i
                      class="nav-rotate-show"
                      :class="{ 'nav-rotate-hide': !navHelpShow }"
                  ...
                  <transition name="slide">
                    <div class="help_sel" v-show="navHelpShow">
                      ...
                      >
                      <span
                        ><a href="javascript:;" @click="redirect('', 2)"
                          >手册下载</a
                        ></span
                      >
                    </div>
                ...
                <li>
                  <router-link
                    ...
                    :to="{
                      path:
                        '/updatelog?ga_source=vip&ga_name=vip_updatelog_list_topnav'
                    }"
                    >更新日志</router-link
                  >
                </li>
            ...
            <router-link
              tag="a"
              to="/login?ga_source=vip&ga_name=introduce"
              v-if="isLogin"
            >
              <div class="logo">
            ...
            <div class="nav_login">
              <div v-if="isLogin">
                <router-link tag="a" to="/login" class="login_btn"
                  >登录</router-link
                >
              </div>
                  ...
                  <div class="el-dropdown-link">
                    <router-link to="/usercenter" class="avatar">
                      <span class="user-img-wrap">
                        <img
                          class="user-img"
                          :src="UserCenterAccountData.picture"
                        />
                      </span>
                    ...
                    <i
                      class="el-icon-caret-bottom el-icon--right icon-color"
                    ></i>
                  </div>
                  <!-- 下拉框 -->
                  <el-dropdown-menu
                    class="la-header-menu"
                    slot="dropdown"
                    placement="top"
                  >
                    <el-dropdown-item class="first">
                      <router-link to="/usercenter/message" target="_blank"
                        >消息通知</router-link
                      >
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <router-link to="/usercenter/take" target="_blank"
                        >订阅管理</router-link
                      >
                    </el-dropdown-item>
                    <!-- <el-dropdown-item><router-link to="/usercenter/collect" target="_blank">收藏管理</router-link></el-dropdown-item> -->
                    <el-dropdown-item>
                      <router-link to="/usercenter/history" target="_blank"
                        >搜索记录</router-link
                      >
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <router-link to="/usercenter/suggest" target="_blank"
                        >建议反馈</router-link
                      >
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <router-link to="/help/list" target="_blank"
                        >帮助中心</router-link
                      >
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <router-link to="/updatelog" target="_blank"
                        >更新日志</router-link
                      >
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <router-link to="/usercenter/account" target="_blank"
                        >账号管理</router-link
                      >
                    </el-dropdown-item>
            ...
            <div class="tohome">
              <div v-if="!isLogin">
                <router-link tag="a" to="/home" class="tohome_btn"
                  >进入数据库</router-link
                >
              </div>
            </div>
            <nav class="nav_right">
              <router-link tag="a" class="right-nav-item" to="/home" exact
                >首页</router-link
              >
              <a
                href="javascript:;"
        ...
        <div class="introduce_top">
          <div class="heder_con">
            ...
            <el-button @click="showProbation('vip_top_applyforatrial')"
              >免费试用</el-button
            >
          </div>
              ...
              <div class="main_con">
                ...
                <div class="introduce-foot">
                  <div class="foot_top">
                    ...
                    <el-button
                      @click="showProbation('vip_bottom_applyforatrial')"
                      class="try"
                      >立即体验</el-button
                    >
                  </div>
                  <div class="footer">
                    <div class="footer_lt">
                      <p class="p1">
                        <a
                          target="_blank"
                          href="https://about.yaozh.com/about.html"
                          >关于我们</a
                        >
                        <a
                          href="https://vip.yaozh.com/help/list"
                          target="_blank"
                          >帮助中心</a
                        >
                        <a
                          :href="
                            `https://${handlerUrl()}.yaozh.com/service?ga_source=vip&amp;ga_position=bottom_help`
                          "
                          target="_blank"
                          >客服中心</a
                        >
                        <a
                          target="_blank"
                          href="https://www.yaozh.com/ued?source=www&amp;name=zhihui_footer"
                          >用户体验计划</a
                        >
                      </p>
                      <p class="p2">
