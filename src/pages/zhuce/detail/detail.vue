          ...
          <div class="left-top">
            <div class="top-id" :title="data.shoulihao">
              ...
              <span
                ...
                "
                :class="{ 'abandon-click-method': nopms.rss }"
                v-if="data.shoulihao != ''"
              >
                <img src="/static/imgs/rss/rss_2.png" v-if="nopms.rss" />
                <img
                  src="/static/imgs/rss/rss_1.png"
                  title="已订阅"
                  v-else-if="!nopms.rss && rssStatus.shoulihao"
                />
                <el-tooltip
                  v-else
                  class="help-tip"
            ...
            <div class="left-bottom">
              <div class="bottom-name">
                ...
                >
                  ...
                  <img
                    src="/static/imgs/rss/rss_1.png"
                    title="已订阅"
                    v-else-if="!nopms.rss && rssStatus.name"
                  />
                  <el-tooltip
                    v-else
                    class="help-tip"
              ...
              <div class="company-name" v-if="data.qiyemingcheng">
                ...
                <span
                  ...
                  "
                  :class="{ 'abandon-click-method': nopms.rss }"
                  v-if="data.qiyemingcheng != ''"
                >
                  <img src="/static/imgs/rss/rss_2.png" v-if="nopms.rss" />
                  <img
                    src="/static/imgs/rss/rss_1.png"
                    title="已订阅"
                    v-else-if="!nopms.rss && rssStatus.qiye"
                  />
            ...
            >
            <span
              class="id-green bg-orange round"
            ...
            >
            <span
              class="icon iconfont yzxpj round"
            ...
            <span
              ...
              v-if="data.banlizhuangtai"
              >{{ data.banlizhuangtai }}</span
            >
          </div>
            ...
            <div class="tb-wrap">
              <table class="tb-t">
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <span
                      :style="wordBreak"
                      class="t-line5"
                      v-if="vueCheckDetailPms('Zhuce', '临床试验登记号')"
                    >
                      <router-link
                        tag="a"
                        :to="'/linchuangshiyan/' + item.id"
                        target="_blank"
                        v-for="(item, index) in data.lcsydjh"
                        :key="index"
                        style="display: inline-block; color: #4877e8"
                        >{{ item.me_id }} &nbsp;&nbsp;</router-link
                      >
                    </span>
                    <span v-else class="abandon-click-method">暂无权限</span>
                  </td>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <span v-if="vueCheckDetailPms('Zhuce', '临床急需境外新药')"
                      >{{ data.lcjxjwxy == 2 ? "是" : "否" }}
                    </span>
                    <span v-else class="abandon-click-method">暂无权限</span>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    >
                      <div
                        slot="content"
                        v-html="helpDesc.deliveryInformation"
                      ></div>
                      <i class="el-icon-question cl-green"></i>
                    </el-tooltip>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <template v-if="data.report != ''">
                      <span
                        class="linksBtn"
                        v-if="vueCheckDetailPms('Zhuce', '审评报告')"
                        @click="redirectNewPage(data.report)"
                        >查看</span
                      >
                      <span v-else class="abandon-click-method">暂无权限</span>
                    </template>
                  ...
                  <td>
                    <template v-if="data.instruct != ''">
                      <span
                        class="linksBtn"
                        v-if="vueCheckDetailPms('Zhuce', '说明书')"
                        @click="redirectNewPage(data.instruct)"
                        >查看</span
                      >
                      <span v-else class="abandon-click-method">暂无权限</span>
                    </template>
