                ...
                >
                  <template slot-scope="scope">
                    <div :title="scope.row[item.prop]">
                      ...
                      <div v-if="item.prop === 'banlizhuangtai'">{{ scope.row.banlizhuangtai }}</div>
                      <div v-if="item.prop === 'zhuangtaidate'">{{ scope.row.zhuangtaidate }}</div>
        ...
        >
          ...
          <template slot-scope="scope">
            <div :title="item.prop==='zdsbpz'||item.prop==='zxzt'?'':scope.row[item.prop]">
              ...
              <div
                v-else-if="item.prop==='zhuangtaidate'"
...
export default {
  ...
  methods: {
    ...
    toggleRowExpansion(row, column, cell, event) {
      ...
      let newColum = ['zdsbpz', 'zhuangtaidate', 'yaopin_high']
      ...
      //前三个字段用表格1
      let tableTypeArr = ['yaopin_high', 'zhuangtaidate', 'zdsbpz']
