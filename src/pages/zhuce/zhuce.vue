<template>
  <Main class="zhuce">
    ...
    <el-dialog class="dialog-saved" :visible.sync="savedPopVisible" :modal-append-to-body="false">
      ...
      <SavedPop @closeSavedPop="closeSavedPop.vue"x_name="Zhuce"></SavedPop>
    </el-dialog>
    ...
    <div slot="left" style="position: relative;">
      ...
      <!-- 热点筛选条件 -->
      <HotFilter vuex_name="Zhuce" route1="list" route2="analy" route3="qb"></HotFilter>
      <!-- 条件筛选（普通/高级搜索之后的二次筛选） -->
      <Filters vuex_name="Zhuce" route1="list" route2="analy" route3="qb"></Filters>
      <!-- 保存的条件 -->
