      ...
      <div class="chart_top">
        <div class="totals">
          <ul class="total-item">
            ...
            <li class="li2">总计<span>{{ kshTotal.name }}</span>个</li>
          </ul>
          <ul class="total-item">
            <li class="li1">生产企业</li>
            <li class="li2">总计<span>{{ kshTotal.qiye }}</span>个</li>
          </ul>
          <ul class="total-item">
            <li class="li1">签发年份</li>
            <li class="li2">总计<span>{{ kshTotal.date }}</span>个</li>
          </ul>
          <ul class="total-item">
            <li class="li1">国产药品</li>
            <li class="li2">总计<span>{{ kshTotal.gc }}</span>个</li>
          </ul>
          <ul class="total-item">
            <li class="li1">进口药品</li>
            <li class="li2">总计<span>{{ kshTotal.jk }}</span>个</li>
          </ul>
        </div>
      </div>
      <div class="chart_bottom">
        <div class="go-list">
          <router-link tag="a" :to="{path:'/pqf/list.vue'}">返回列表</router-link>
        </div>
        <div class="chart-boxes">
          <DbEcharts :title="item.title" v-for="(item,i) in echartsList" :key="i">
...
export default {
  ...
  methods: {
    ...
    drawSqlxBar() {
      var _that = this;
      _that.sqlx_bar.echarts = Echarts.init(document.getElementById("sqlx-bar"));
    ...
    drawYplxBar() {
      var _that = this;
      _that.yplx_bar.echarts = Echarts.init(document.getElementById("yplx-bar"));
    ...
    drawSpjlPie() {
      var _that = this;
      _that.spjl_pie.echarts = Echarts.init(document.getElementById("spjl-pie"));
  ...
  watch: {
    ...
    $route(){
      if(this.$route.path==='/pqf/analy'&&Object.keys(this.kshRes).length<=1){
        this.loadData()
      }
      ...
      if(this.$route.path==='/pqf/list.vue'){
