    ...
    <div class="detail-list" v-else>
      <div class="detail-header">
        <div class="header-left">
          <div class="left-top">
            <span class="top-id" :title="baseInfos.title">{{baseInfos.title}}</span>
      ...
      <div class="main">
        <div class="sections">
            ...
            <div class="con">
                ...
                <div class="detail" v-if="baseInfos.money">
                  ...
                  <span class="smail-con" v-if=" !isNaN(baseInfos.money)">{{baseInfos.money}}万元</span>
                ...
                <div class="detail detailone">
                  ...
                  <div class="company">
                    ...
                    <div v-if="qiyeInfos.qybq" class="qybq">
                      <span v-for="(item, index) in qybqArr" :key="index">{{item}}</span>
                    </div>
                  </div>
                </div>
                <div class="detail detailtwo">
                  <span class="smail-title lt1">企业简介：</span>
                  <span class="smail-con lt2" v-if="qiyeInfos.qyjj">{{qiyeInfos.qyjj}}</span>
                  <span class="smail-con lt2" v-else>暂未公布</span>
                </div>
                <div class="detail" >
                  <span class="smail-title">企业类型：</span>
                  <span class="smail-con" v-if="qiyeInfos.qylx" >{{qiyeInfos.qylx}}</span>
                  <span class="smail-con" v-else>暂未公布</span>
                </div>
                <div class="detail">
                  <span class="smail-title">成立时间：</span>
                  <span class="smail-con"  v-if="qiyeInfos.clrq">{{qiyeInfos.clrq}}</span>
                  <span class="smail-con" v-else>暂未公布</span>
                </div>
                <div class="detailthree">
                  <a :href="'/company/'+qiyeInfos.id" class="more" target="_blank">更多企业信息</a>
                </div>
        ...
        <div class="sections" v-if="timelineInfos.length">
            ...
            <div class="timeline-con">
                <div class="time-line">
                  <div class="time-con" v-for="(list,idx) in timelineInfos" :key="idx">
                    <div class="node-left">
                    ...
                    <div class="node-right">
                      <el-tooltip class="help-tip" effect="useInfoDark" :content="list.funders" placement="bottom">
                        <span class="node-czf" >出资方：{{list.funders}}</span>
                      </el-tooltip>
                     
                      <span class="node-money" v-if=" !isNaN(list.money)">金额（RMB）：{{list.money}}万元</span>
                      <span class="node-money" v-else>金额（RMB）：{{list.money}}</span>
  ...
  export default {
    ...
    methods: {
      handleAxios () {
        window.Axios({
          method: 'get',
          url: '/api/tourongzi/' +this.$route.params.id ,
          params: {
    ...
    mounted() {
      Store.dispatch("Tourongzi/getBaseInfo")
    },
    activated() {
