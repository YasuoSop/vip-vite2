                 ...
                 <div class="service_nav">
                     <div class="service_header">
                        ...
                        <nav class="nav_right">
                            ...
                            <router-link tag="a" class="right-nav-item" to="/help?ga_source=vip&ga_name=vip_service_topnav" exact>帮助中心</router-link>
                            <router-link tag="a" class="right-nav-item" to="/updatelog?ga_source=vip&ga_name=vip_updatelog_list_topnav" exact>更新日志</router-link>
                            <router-link tag="a" class="right-nav-item" to="/service?ga_source=vip&ga_name=vip_service_topnav" exact>客服中心</router-link>
                        ...
                        <div class="container">
                            ...
                            <div class="yaozh-service">
                                ...
                                <div class="yaozh-service-child clearfix">
                                    <div class="vline"></div>
                                    <div class="mark">
                                        <p class="child-title"><i class="iconfont" style="font-size: 18px;">&#xe67c;</i>药智咨询</p>
                                        <p class="child-desc">
                                            <ul>
                            ...
                            <div class="consult-services clearfix">
                                <ul>
                                    <li v-for="(items, idx) in zixunService" :key="idx">
                                        <img :src="items.head_icon != '' ? items.head_icon : require('@/assets/imgs/service/kefu-women.png')" v-if="items.gender == 1" />
                                        <img :src="items.head_icon != '' ? items.head_icon : require('@/assets/imgs/service/kefu-man.png')" v-else />
                                        <p class="uname">{{items.username}}</p>
                                        <p>{{items.introduction}}</p>
                                        <p><span class="phone"></span>{{items.phone}}</p>
                                        <p><a class="chat chat1" :href="'tencent://message/?uin='+items.qq+'&Site=&Menu=yes'"><span></span>在线咨询</a></p>
                                    </li>
                                </ul>
                            </div>
                        </div>
