<template>
  <div class="lists">
    <el-tabs :value="activeTabName" @tab-click="handleClickTag" class="la-list globalapproval-list" :before-leave="beforeLeave">
      <el-tab-pane
        :label="getTabLabel('按药品名称浏览',extendCount.BaseCount)"
        name="first"
        class="slh-pane">
        <ListOne></ListOne>
      </el-tab-pane>
      ...
      <el-tab-pane name="fensantu"
      :disabled="nopms.cname"
      :class="{'abandon-click-method': nopms.cname}">>
        <span slot="label" v-if="!nopms.cname"> <img src="../../../static/imgs/fensantu.png" alt="" style="vertical-align: middle"> 单品种分析</span>
        <span slot="label" v-else> <img src="../../../static/imgs/fensantu_gray.png" alt="" style="vertical-align: middle"> 单品种分析</span>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
