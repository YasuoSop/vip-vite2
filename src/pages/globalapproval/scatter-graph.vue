              ...
              >
                <div slot="content">
                  <el-scrollbar>
                    <div
                      class="tip-content"
                      v-html="help_conf.remark ? help_conf.remark : ''"
                    ></div>
                  </el-scrollbar>
                  <a
                    class="btn default"
        ...
        class="iconfont">&#xe615;</span> -->
                    ...
                    >
                      <span class="btn option">
                        ...
                        <span
                          class="el-icon-close"
                          @click="handleSourceCloseClick(0)"
                        ></span>
                      </span>
                    </div>
                    <!-- 全球上市条件筛选国家或地区特殊处理 -->
                    ...
                    >
                      <span class="btn option">
                        ...
                        <span
                          class="el-icon-close"
                          @click="handleSourceCloseClick(1)"
                        ></span>
                      </span>
                    </div>
                    <!-- 保存 & 清空 -->
                    <div
                      class="wrap-add-del"
                      v-if="
                        selected_types.length > 0 || selected_areas.length > 0
                      "
                    >
                      <span
                        class="btn clear-options"
                        @click="handleAllCloseClick"
...
import notSupportIE from "@/components/common/not-supportIE.vue.vue"
import { mapState } from "vuex";
import LoadingGif from "@/components/common/globalCom/loading-gif.vue"
const scatterGraphComponent = () => ({
  component: import(
    "@/components/common/globalapproval/scatter-graph-component.vue.vue"
  ),
  delay: 200
});
...
export default {
  ...
  methods: {
    handleSourceCloseClick(type) {
      ...
      this.$nextTick(() => {
        this.search(this.types, this.areas);
      });
    },
    handleAllCloseClick() {
      let activeFilter = this.$refs["scatter-search"].activeFilter;
