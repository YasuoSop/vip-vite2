<template>
  <div class="wrapper globalapproval-detail" ref="wrapper">
    ...
    <div class="detail-list" style="padding-top: 50px" v-else>
      <div
        class="detail-header header-fixed"
        :style="{ top: (showPromtNotice ? 78 : 48) + 'px' }"
      ...
      <ul class="basic-info">
        ...
        >
          <label>靶点</label>
          <span
            style="width: 100%;word-break: break-word;flex-wrap: wrap;"
            class="t-line5"
          >
        ...
        <li v-if="data.drugscountry">
          ...
          <div class="ssgj-words" :style="wordBreak">
            <span
              ...
              "
              v-for="(item, index) in data.drugscountry.thicker"
              :key="'bold' + index"
            ...
            <span
              class="ssgj-word"
              v-if="data.drugscountry.pin && data.drugscountry.pin.length > 0"
              v-for="(item, index) in data.drugscountry.pin"
              :key="index"
              >{{ item }}</span
            >
          </div>
        ...
        <div class="left-nav">
          <div class="nav-list nav-event" @click="handleNavClick">
            <a
              ...
              :data-index="0"
              v-if="pzlcData.length > 0"
              >批准历程</a
            >
            <a class="nav-item" :data-index="1" v-if="ssgjData.length > 0"
              >上市国家</a
            >
            <a class="nav-item" :data-index="2">剂型分布</a>
            <a class="nav-item" :data-index="3" v-if="qqxsData.length > 0"
              >全球销售</a
            >
          </div>
        </div>
        <div class="right-list">
          <keep-alive>
            <slide-section
              ...
              v-if="pzlcData.length > 0 && index === 0"
            >
            ...
            <slide-section
              ...
              v-else-if="ssgjData.length > 0 && index === 1"
            >
              <ssgjDetail
                :name="data.activeingredient"
                :cname="data.cname"
                :data="ssgjData"
              />
            </slide-section>
            <slide-section
              ...
              v-else-if="jxfbData.length > 0 && index === 2"
            >
              <jxfbDetail
                :name="data.activeingredient"
                :cname="data.cname"
            ...
            <slide-section
              ...
              v-else-if="qqxsData.length > 0 && index === 3"
            >
