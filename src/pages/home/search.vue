    ...
    <form class="c-search-form">
      <div class="comprehensive-check">
        <div
          ...
          :key="index"
          @click="handleCategoryClick(sc)"
          :class="{'active': sc === searchCategory}"
          :searchCategory="sc">
      ...
      <inputPopover :value="searchwords">
        <div class="c-search-input">
          <el-input
            ...
            @focus="handleHomeSearchInputFocus(trimKeyword, searchwords)"
      ...
      <div class="hot" v-if="hot_keys && hot_keys.length">
        ...
        <span>热门搜索：</span>
        <router-link
          :to="{path: '/search', query: {comprehensive: searchCategory, searchwords: key, source: '2'}}"
          v-for="(key, index) in hot_keys"
          :key="index">
          {{key}}
        </router-link>
      </div>
...
import { mapState } from 'vuex'
  export default {
    ...
    data () {
      return {
        historyFlag: false,
        searchCategorys: ['drug','targets','company','devices','disease','chinesemedicine'],
        comprehensive: '',
        hot_keys: [],
        history_keys: [],
        input_keys: [],
