  ...
  <div class="analy-wrapeer">
    ...
    <div class="chart">
          ...
          <div class="newtotals-scroll">
            <div class="newtotals-scroll-inner">
              <ul class="total-item">
                ...
                <li class="li2"><span>{{ typeof(kshTotal.yp) == 'undefined' ? 0 : kshTotal.yp }}</span>个</li>
              </ul>
              <ul class="total-item">
                <li class="li1">药材数量</li>
                <li class="li2"><span>{{ typeof(kshTotal.yc) == 'undefined' ? 0 : kshTotal.yc }}</span>种</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="chart_bottom">
        <div class="go-list">
          <router-link tag="a" :to="{path:'/chufang/list.vue'}">返回列表</router-link>
        </div>
...
export default {
  ...
  methods: {
    ...
    drawSqlxBarOpen() {
          ...
          toolbox: {
            feature: {
              ...
              myTogglePie: {
                ...
                icon: "image:///static/imgs/echarts/pie.png",
                onclick() {
                  _that.handleTogglePie("sqlx-bar-open", _that.sqlx_bar, undefined);
                }
              }
            }
          },
      ...
      Echarts.init(document.getElementById("yclx-bar-open")).setOption({
    ...
    ycfxSqlxBar(originalData) {
      ...
      if (_len > 0) {
        ...
        for (var i = 0; i < _len; i++) {
          ...
          series_data.push({ value: originalData[i].num, name: originalData[i].yaocai });
        }
    ...
    ycfxDrawSqlxBar() {
      var _that = this;
      _that.yclx_bar2.echarts = Echarts.init(document.getElementById("yclx-bar"));
  ...
  watch: {
    ...
    $route(){
      if(this.$route.path==='/chufang/analy'&&Object.keys(this.kshRes).length<=1){
        this.loadData()
      }
      ...
      if(this.$route.path==='/chufang/list.vue'&&!this.res1.length){
