...
export default {
    ...
    actions: {
        ...
        exportAsExcel(state, Payload) {
            let paramsStr = state.state.exportParamsStr ? state.state.exportParamsStr + '&' : '',
                url = `/api/yyxs/analyoutdata?${paramsStr}
                    outdata_action=${Payload.outdata_action}&
                    outdata_column=${Payload.outdata_column},tablename=医院销售数据挖掘系统-${Payload.moduleName}&
                    accesstoken=${GETCOOKIEFUN("accesstoken")}&
